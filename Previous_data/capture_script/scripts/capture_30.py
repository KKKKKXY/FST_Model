...
def multiControllerNet():
    ...
    for x in range(1, 11):
        result = open("/home/mya/capture_script/capture_result_30.txt","a")
        info("====================================Starting " + str(x) + " FOR LOOP====================\n")
        result.write("\n")
        result.write("\n")
        info("*** h1 FLUSH\n")
        time.sleep(2)
        h1.cmd("ip -s -s neigh flush all >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)

        info( "*** h2 FLUSH\n" )
        time.sleep(2)
        h2.cmd("ip -s -s neigh flush all >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)

        info( "*** s1 FLUSH\n" )
        time.sleep(2)
        s1.cmd("ip -s -s neigh flush all >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)

        info( "*** s2 FLUSH\n" )
        time.sleep(2)
        s2.cmd("ip -s -s neigh flush all >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)

        info( "*** s1 DELETE FLOW\n" )
        time.sleep(2)
        s1.dpctl("del-flows -O OpenFlow13 >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)
        s1.dpctl("dump-flows -O OpenFlow13 >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)

        info( "*** s2 DELETE FLOW\n" )
        time.sleep(2)
        s2.dpctl("del-flows -O OpenFlow13 >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)
        s2.dpctl("dump-flows -O OpenFlow13 >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)

        info( "*** Starting PING\n" )
        time.sleep(2)
        h1.cmd("ping 10.0.0.2 -c 2 >> /home/mya/capture_script/capture_result_30.txt")
        time.sleep(2)
