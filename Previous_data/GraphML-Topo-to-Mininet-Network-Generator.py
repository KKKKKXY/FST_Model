...
tempstring5 = ''
# controllers
controller_ip_split = controller_ip.split(",")
for ip_index in range(0, len(controller_ip_split)):
    temp5 =  '    c'
    temp5 += str(ip_index+1)
    temp5 += " = net.addController('c"
    temp5 += str(ip_index+1)
    temp5 += "', controller=RemoteController, ip='"
    temp5 += controller_ip_split[ip_index]
    temp5 += "', port=6653"
    temp5 += " )\n"
    tempstring5 += temp5
